...
import { Lock, Mail, User, UserPlus, Utensils } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <Text style={styles.subtitle}>Start tracking your meals with local food support.</Text>
          ...
          <View style={styles.linkRow}>
            ...
            <Link href="/(auth)/login" style={styles.linkAccent}>
              Log in
            </Link>
          </View>
        </ScrollView>
